...
When a request fails due to business logic (e.g. invalid parameters, quota limits, resource conflicts), the API returns a structured error body alongside the HTTP status code:
