...
<Note>
**Permission required:** [`project:mem_conflict_resolve`](/features/team-collaboration/permission-reference#resolve-conflicting-memories) · `instance`
</Note>
