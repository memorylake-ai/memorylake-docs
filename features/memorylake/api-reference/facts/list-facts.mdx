...
Returns a paginated list of facts stored in a project. Facts are structured pieces of knowledge automatically extracted from conversations. You can filter facts by content with `fact_fuzzy`.
