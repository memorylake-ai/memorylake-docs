...
<Note>
Deleting a file that is referenced by one or more project documents does not automatically remove those documents. Call [Remove Documents](/features/memorylake/api-reference/memories/remove-documents) first if you want the documents to disappear from a project.
</Note>
