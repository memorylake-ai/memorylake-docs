---
title: "List Agents"
description: "Returns a paginated list of agents with optional name search"
---
...
Returns a paginated list of all agents in your account. You can search by name with `name_fuzzy` and control pagination with `page_size` and `continuation_token`.
