...
<Expandable title="Subagent object">
  ...
  <ParamField body="subagents[].mode" type="string">Execution mode: `fork` or `swarm`</ParamField>
...
<Expandable title="Agent object">
  ...
  <Expandable title="Subagent object">
    ...
    <ResponseField name="mode" type="string">Execution mode: `fork` or `swarm`</ResponseField>
