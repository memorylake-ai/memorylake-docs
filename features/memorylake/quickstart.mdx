...
<Tip>
Have some sample documents ready? PDFs, Office documents (Word, Excel, PowerPoint), text/Markdown files, and images all work great with MemoryLake.
</Tip>
...
<Note>
MemoryLake supports common document formats — PDF, Microsoft Word, Excel, PowerPoint, text/Markdown, and images. Large files are automatically handled with multi-part uploads.
</Note>
