...
You'll encounter documents in two places in the console:

- **Library** (sidebar → Advanced → Library): your full personal file store, with the folder tree, comments, and connector spaces
- **Project Files tab**: the documents associated with a specific project, with their processing status — see [Document Association](/features/memorylake/project-management/document-association)
...
- **Supported File Types**:
  ...
  - Spreadsheets: Microsoft Excel, CSV, TSV
...
3. Add Markdown comments to tag documents by category or status
4. Associate the right folders with team projects so members' assistants share the context
</Accordion>
...
MemoryLake parses and indexes the following document types:

- **PDF** — portable document format
- **Microsoft Word** — Word documents and templates
- **Microsoft Excel** — Excel workbooks and templates, plus CSV and TSV data
- **Microsoft PowerPoint** — PowerPoint presentations and templates
- **Text and Markdown** — plain text and Markdown notes
- **Images** — PNG, JPEG, GIF, BMP, WebP, and TIFF
...
- **Integrations**: Provide AI assistants and agents with search access to your documents
