...
Role: `tenant_admin`, `tenant_member`, or a custom role key of this team. The owner role cannot be assigned. [List Roles](/features/management-api/members/list-roles) returns every value your team accepts.
</ParamField>
