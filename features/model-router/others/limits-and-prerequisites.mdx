...
- At least one API key created in the [console](https://app.memorylake.ai/panel/token) and associated with the correct API key group or team context.  
...
## Pre-Use Checklist
1) In the [console](https://app.memorylake.ai/panel), confirm the current API key's group, context (personal/team), and basic quota.  
