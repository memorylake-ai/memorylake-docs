...
- **base_url**：Model Router 服务地址（如 `https://api.onehub.cn/v1`）
...
<Frame>
  <img
    ...
    src="/images/ai-applications/codex-cli/get-api-key.png"
...
name = "Model Router"
base_url = "https://api.onehub.cn/v1"
wire_api = "responses"
```
...
3) **API 地址**：确保 `base_url` 包含 `/v1` 路径，例如 `https://api.onehub.cn/v1`。  
