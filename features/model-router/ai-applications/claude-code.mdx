...
- **ANTHROPIC_AUTH_TOKEN**: API Key obtained from the [Memorylake Console](https://app.memorylake.ai/panel/token) (starts with `sk-`)
...
Click "Add Token" on the [token management page](https://app.memorylake.ai/panel/token) in the Memorylake Console to get an API Key.
...
1) **Get API Key**: Ensure you have generated a valid API Key in the [Memorylake Console](https://app.memorylake.ai/panel/token) (starts with `sk-`).  
...
- API Key must start with `sk-`; ensure it's correctly obtained from the [Memorylake Console](https://app.memorylake.ai/panel/token).
