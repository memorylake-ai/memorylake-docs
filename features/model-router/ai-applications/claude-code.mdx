...
- **ANTHROPIC_BASE_URL**：Model Router 服务地址（如 `https://app.memorylake.ai`）
...
export ANTHROPIC_BASE_URL=https://app.memorylake.ai
claude
```
...
echo -e '\n export ANTHROPIC_BASE_URL=https://app.memorylake.ai' >> ~/.bash_profile
echo -e '\n export ANTHROPIC_AUTH_TOKEN=sk-...' >> ~/.bashrc
echo -e '\n export ANTHROPIC_BASE_URL=https://app.memorylake.ai' >> ~/.bashrc
```
...
echo -e '\n export ANTHROPIC_BASE_URL=https://app.memorylake.ai' >> ~/.zshrc
```
...
2) **配置 API 地址**：使用正确的 Model Router 服务地址，例如 `https://app.memorylake.ai`。  
