...
<CodeGroup>
```ts TypeScript
await fetch("https://api.platform.com/claude/v1/messages", {
  method: "POST",
  headers: {
    "Authorization": "Bearer sk-demo123",
    "Content-Type": "application/json"
...
resp = requests.post(
    "https://api.platform.com/claude/v1/messages",
    headers={
        "Authorization": "Bearer sk-demo123",
        "Content-Type": "application/json",
    },
...
```
```bash cURL
curl https://api.platform.com/claude/v1/messages \
  -H "Authorization: Bearer sk-demo123" \
  -H "Content-Type: application/json" \
  -d '{
    "model": "claude-3-opus-20240229",
...
<CodeGroup>
```ts TypeScript
await fetch("https://api.platform.com/gemini/v1beta/models/gemini-1.5-pro:generateContent", {
  method: "POST",
  headers: {
    "Authorization": "Bearer sk-demo123",
    "Content-Type": "application/json"
...
resp = requests.post(
    "https://api.platform.com/gemini/v1beta/models/gemini-1.5-pro:generateContent",
    headers={
        "Authorization": "Bearer sk-demo123",
        "Content-Type": "application/json",
    },
...
```
```bash cURL
curl https://api.platform.com/gemini/v1beta/models/gemini-1.5-pro:generateContent \
  -H "Authorization: Bearer sk-demo123" \
  -H "Content-Type: application/json" \
  -d '{
    "contents": [{"role": "user", "parts": [{"text": "生成一个标题"}]}]
...
<CodeGroup>
```ts TypeScript
await fetch("https://api.platform.com/midjourney/imagine", {
  method: "POST",
  headers: {
    "Authorization": "Bearer sk-demo123",
    "Content-Type": "application/json"
...
resp = requests.post(
    "https://api.platform.com/midjourney/imagine",
    headers={
        "Authorization": "Bearer sk-demo123",
        "Content-Type": "application/json",
    },
...
```
```bash cURL
curl https://api.platform.com/midjourney/imagine \
  -H "Authorization: Bearer sk-demo123" \
  -H "Content-Type: application/json" \
  -d '{
    "prompt": "sunrise over a lake, cinematic",
...
<CodeGroup>
```ts TypeScript
await fetch("https://api.platform.com/suno/jobs", {
  method: "POST",
  headers: {
    "Authorization": "Bearer sk-demo123",
    "Content-Type": "application/json"
...
resp = requests.post(
    "https://api.platform.com/suno/jobs",
    headers={
        "Authorization": "Bearer sk-demo123",
        "Content-Type": "application/json",
    },
...
```
```bash cURL
curl https://api.platform.com/suno/jobs \
  -H "Authorization: Bearer sk-demo123" \
  -H "Content-Type: application/json" \
  -d '{
    "prompt": "soft piano background music",
...
<CodeGroup>
```ts TypeScript
await fetch("https://api.platform.com/tasks/tsk_12345", {
...
resp = requests.get(
    "https://api.platform.com/tasks/tsk_12345",
    headers={"Authorization": "Bearer sk-demo123"}
)
```
```bash cURL
curl https://api.platform.com/tasks/tsk_12345 \
  -H "Authorization: Bearer sk-demo123"
```
</CodeGroup>
