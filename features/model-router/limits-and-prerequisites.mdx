...
- At least one token created in the console and associated with the correct token group or team context.  
...
## Pre-Use Checklist
1) In the console, confirm the current token's group, context (personal/team), and basic quota.  
