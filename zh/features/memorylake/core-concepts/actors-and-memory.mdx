...
详情请参阅[绑定 Actor API 参考](/zh/features/memorylake/api-reference/actors/bind-actor)。
...
<Card title="Actor API" icon="code" href="/zh/features/memorylake/api-reference/actors/overview">
Actor 操作的完整 API 参考
</Card>

<Card title="Actor 事实 API" icon="code" href="/zh/features/memorylake/api-reference/facts/list-actor-facts">
