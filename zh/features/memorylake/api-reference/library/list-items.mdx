---
title: "列出项目"
description: "列出资料库中某个文件夹下的文件和子文件夹"
---
...
返回文件夹下的直接子项（文件和文件夹）。使用游标分页：如果响应中返回了 `continuation_token`，将其传回下一次请求以获取下一页。当响应中不包含该令牌时，表示已到达末尾。
