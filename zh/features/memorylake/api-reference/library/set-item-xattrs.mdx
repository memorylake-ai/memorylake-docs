...
此调用会与条目已有的 xattrs **合并**：您发送的键会被新增或覆盖；条目上已有但本次未发送的键保持不变。要移除某个键，请调用[删除条目扩展属性](/zh/features/memorylake/api-reference/library/delete-item-xattrs)。
...
<Note>
**所需权限：** [`drive:item_modify`](/zh/features/team-collaboration/permission-reference#编辑文件) · `service`
</Note>
...
<Tip>
要读取条目当前的 xattrs，请调用[获取条目](/zh/features/memorylake/api-reference/library/get-item) — 其响应包含完整的 `x_attrs` 映射。
</Tip>
