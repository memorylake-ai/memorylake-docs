...
<Expandable title="分页的成员列表">
  ...
  <Expandable title="成员对象">
    ...
    <ResponseField name="member_type" type="string">`human`（通过邀请加入）或 `virtual`（由 Owner/Admin 创建的受管身份 —— 参见[创建虚拟成员](/zh/features/management-api/members/create-member)）</ResponseField>
