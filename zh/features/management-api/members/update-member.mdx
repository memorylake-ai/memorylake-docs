...
来自[成员列表](/zh/features/management-api/members/list-members)的成员标识符
</ParamField>
...
新角色：`tenant_admin`、`tenant_member`，或本团队的某个自定义角色标识。[列出角色](/zh/features/management-api/members/list-roles)返回全部合法取值。
</ParamField>
