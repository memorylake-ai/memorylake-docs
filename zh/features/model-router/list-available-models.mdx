...
<Info>
只有为您的 API Key 分组启用的模型才会出现在列表中。如果您没有看到预期的模型，请联系管理员或查看[限制与前提条件](/zh/features/model-router/others/limits-and-prerequisites)。
</Info>
...
<Info>
模型列表中的定价信息仅供参考。实际计费根据您的用量计算。详情请参阅[查看用量与计费](/zh/features/model-router/view-usage-and-billing)。
</Info>
