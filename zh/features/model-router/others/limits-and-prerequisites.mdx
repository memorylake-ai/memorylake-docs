...
- 一个账户，并已登录[控制台](https://app.memorylake.ai)
- 在您准备发起调用的空间（个人或团队）下，通过 **API Keys** 至少创建了一个 API Key
- 充足的余额——配额不足时调用会被拒绝（参阅[计费](/zh/features/model-router/view-usage-and-billing)）
...
- **角色**：管理团队配额、查看团队级用量、调整成员额度取决于您的团队角色——参阅[角色与权限](/zh/features/team-collaboration/roles-permissions)。
