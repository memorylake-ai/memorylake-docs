...
Create a [workspace](/concepts#workspace) per major domain — "Product", "Customer Success", "Legal" — or per client engagement. Members join workspaces automatically; each workspace holds its own projects, memories, and agents.
</Step>
