...
Create one [Boundary](/concepts#boundary-memory-router) per user (it binds workspace + project + actors into a single scope id), then route calls through the gateway:
